...
export class DashboardComponent implements OnInit {
  ...
  displayedColumns: string[] = ['productId', 'position', 'name', 'weight', 'symbol'];
  dataSource = [
    { productId: 'P1', position: 1, name: 'Hydrogen', weight: 1.0079, symbol: 'H' },
    { productId: 'P2', position: 2, name: 'Helium', weight: 4.0026, symbol: 'He' },
    { productId: 'P3', position: 3, name: 'Lithium', weight: 6.941, symbol: 'Li' },
